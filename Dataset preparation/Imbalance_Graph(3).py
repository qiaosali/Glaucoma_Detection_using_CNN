...
#Imbalance Graph
# data = pd.read_csv('F:/datasets/glaucoma.csv')
...
sns.barplot(x=glaucoma_counts.index, y=glaucoma_counts.values)
...
# output_dir = r"F:/datasets/organized_data"
...
# no_path = r"F:/datasets/organized_data/no/images"
# yes_path = r"F:/datasets/organized_data/yes/images"
