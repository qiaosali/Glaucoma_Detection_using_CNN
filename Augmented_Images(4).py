...
yes_images_folder = "F:/Thesis/Project_PyQt6/pyqt6/datasets/organized_data/yes/images"
output_dir = "F:/Thesis/Project_PyQt6/pyqt6/datasets/organized_data/aug_yes"
aug_images_folder = os.path.join(output_dir, "images")
aug_csv_folder = os.path.join(output_dir, "csv")
yes_csv_path = "F:/Thesis/Project_PyQt6/pyqt6/datasets/organized_data/yes/csv/data.csv"
